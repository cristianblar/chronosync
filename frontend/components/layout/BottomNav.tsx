...
const items = [
  ...
  { href: "/tracking", label: "Tracking", Icon: ChartIcon },
  { href: "/education", label: "Aprender", Icon: BookIcon },
...
export function BottomNav() {
  ...
  return (
    <nav aria-label="Navegación principal" className="fixed bottom-0 left-0 right-0 z-40 border-t bg-white/95 backdrop-blur">
